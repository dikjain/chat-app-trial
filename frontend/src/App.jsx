...
function App({username}) {
  ...
  return (
    <div id="main" className='w-screen max-h-screen h-screen bg-[rgba(0,0,0,0.8)] relative flex items-center justify-center'>
       ...
       <div id="onlineuser" className='w-[15%] h-fit bg-blue-300 p-3 text-[2.5vw] absolute left-[10%] top-[15%] rounded-xl'>
      ...
      <div id="container" className='w-[40%] overflow-y-scroll h-[70%] msgprnt py-5  rounded-xl flex flex-col items-center justify-start bg-blue-300'>
